...
const GiveFeedback = () => {
    ...
    return (
        <div>
            {(!loading && data) &&
                (<>
                {(!done) && (<div className="text-center text-textCommon text-2xl mt-20 futuraMedium">
                ...
                (<div className="text-center my-4">
                    <div className="text-2xl my-24 text-primarymain futuraBold"> Your feedback has been sent!</div>
                    <div className="px-10">
                        <FacebookAuth/>
                       <div className="text-sm text-textCommon opacity-75 futuraMedium py-10 w-1/2 mx-auto">
                           If you are new or already has a login try to signIn and get your feedback from your friends.
                        </div> 
                    </div>
                </div>)}
            </>)
